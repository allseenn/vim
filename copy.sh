...
sudo wget https://github.com/vim/vim/blob/master/runtime/autoload/syntaxcomplete.vim -O /usr/share/vim/vim$(/usr/bin/vim --version | head -1 | awk '{ print $5 }' | sed 's/\.//g')/autoload/syntaxcomplete.vim
